...
i18n
  .use(initReactI18next) // Inicializa el plugin de React
  .init({
    fallbackLng: 'de',
  ...
  resources: {
    de: {
      translation: {
        ...
        aboutMeDescription: 'Ich bin <span class="font-lobster led-effect-aboutMe age-span">18 Jahre alt</span>, aus Spanien, Madrid und ich bin derzeit <span class="font-lobster led-effect-aboutMe role-span">Applikationsentwickler Student</span> in meinem zweiten Jahr und ich liebe das Programmieren. Ich habe Grundkenntnisse in <span class="font-lobster led-effect-aboutMe skills-span">Frontend</span> und <span class="font-lobster led-effect-aboutMe">Backend</span>.',
        languages: 'SPRACHEN.',
        german: 'Deutsch',
        spanish: 'Spanisch',
        english: 'Englisch',
        skillsTitle: 'FÄHIGKEITEN',
        skillsSubtitle: 'Fähigkeiten',
    ...
    en: {
      translation: {
        ...
        aboutMeDescription: 'I am <span class="font-lobster led-effect-aboutMe age-span">18 years old</span>, from Spain, Madrid and I am currently a <span class="font-lobster led-effect-aboutMe role-span">Application Developer Student</span> in my second year and I love programming. I have basic knowledge in <span class="font-lobster led-effect-aboutMe skills-span">Frontend</span> and <span class="font-lobster led-effect-aboutMe">Backend</span>.',
        languages: 'LANGUAGES.',
        german: 'German',
        spanish: 'Spanish',
        english: 'English',
    ...
    es: {
      translation: {
        ...
        aboutMeDescription: 'Tengo <span class="font-lobster led-effect-aboutMe age-span">18 años</span>, soy de España, Madrid y ahora mismo soy <span class="font-lobster led-effect-aboutMe role-span">estudiante de desarrollo de aplicaciones</span> en mi segundo año y me encanta programar. Tengo conocimientos basicos en <span class="font-lobster led-effect-aboutMe skills-span">Frontend</span> y <span class="font-lobster led-effect-aboutMe">Backend</span>.',
        languages: 'IDIOMAS.',
        german: 'Aleman',
        spanish: 'Español',
        english: 'Ingles',
